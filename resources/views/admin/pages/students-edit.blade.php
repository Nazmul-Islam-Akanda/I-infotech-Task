...
<p><img src="{{url('/storage/uploads/'.$student->image)}}" width="100px" alt="Picture"> </p>
...
<div class="mb-3">
    ...
    <input name="name" placeholder='Enter Name' value="{{$student->name}}" type="string" class="form-control" id="">
  </div>
                ...
                <div class="row field_wrapper" style="display: flex;"> 
                    ...
                    <div class="delete row d-flex">
                      ...
                      <div class="col-2">
                        ...
                        <option @if($student_res->subject_id==$subject->id) selected @endif value="{{$subject->id}}">{{$subject->subject_name}}</option>
                         @endforeach
                        </select>
                        </div>  

                         <div class="col-1"> </div> &emsp;&emsp; 

                          <div class="col-2">
                            <input type="number" name="number[]" value="{{$student_res->achieve_number}}"/>
                          </div>      

                           <div class="col-2"></div> &emsp;&emsp; 

                           <div class="col-4"><a href="javascript:void();" class="remove_button btn btn-danger">Delete</a> </div>
                          </div> <br><br>
                          @endforeach
...
<br>
  ...
  <button type="submit" class="btn btn" style="background-color:#33C65B; color:white" >Update</button>
</form>
